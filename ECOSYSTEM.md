...
Repository: `SmartEnergySolutions/cernion-openclaw-sidecar`  
Mainline branch: `main`

## This repository's role

Agent-facing OpenClaw bridge to Cernion evidence tools and policy-bounded energy capabilities.

## This repository owns

- OpenClaw tool descriptors and manifests
- agent-side policy boundaries
- request normalization for Cernion evidence tools
- safe usage examples for agent prompts

## This repository consumes or connects to

- Cernion Energy Tools REST/Sidecar capabilities
- public Cernion metadata such as OpenAPI or llm context where needed
